...
numOp op x           y         = throw $ TypeException "expecting two numeric arguments"

stringOp op (String x) (String y) = return $ Number $ op x y
stringOp op x           y         = throw $ TypeException "expecting two string arguments"
